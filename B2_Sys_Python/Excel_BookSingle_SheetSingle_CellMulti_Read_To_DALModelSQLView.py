...
ExcelFile_Path =("P:/Professional_Mission/Part_2_2/Fuschia_Research/Automation_SQL/03.Actual/11.xlsx") 
"""
...
"""
ExcelFile_Sheet_Index_List =[0,1,2]
ExcelFile_SheetXEnd_Index_List =[ [0 , 1],[ 0, 3],[ 0, 4] ]
ExcelFile_SheetYEnd_Index_List =[ [0 , 2],[ 0,16],[ 0,16] ] 
...
Sheet_Row=[]
Sheet_Col=[]
for Sheet_List_Index in range(0,len(ExcelFile_Sheet_Index_List)):
    Sheet_Col.append(int(ExcelFile_SheetXEnd_Index_List[Sheet_List_Index][1])-int(ExcelFile_SheetXEnd_Index_List[Sheet_List_Index][0]))
    Sheet_Row.append(int(ExcelFile_SheetYEnd_Index_List[Sheet_List_Index][1])-int(ExcelFile_SheetYEnd_Index_List[Sheet_List_Index][0]))
    #print(Sheet_Row[Sheet_List_Index])
    #print(Sheet_Col[Sheet_List_Index])
# -----------
for Sheet_List_Index in range(0,len(ExcelFile_Sheet_Index_List)):
    # -----------
    TableBlueprint_Structure = Excel_Open.sheet_by_index(ExcelFile_Sheet_Index_List[Sheet_List_Index]) 
    X_Start = 0
    Y_Start = 0    
    X_End = Sheet_Col[Sheet_List_Index] + 1 
    Y_End = Sheet_Row[Sheet_List_Index] + 1 # for range increase purppose
    # -----------
...
Constraint_List = [[['Not Null', 'Unique'], ['Primary Key', 'Identity(001,1)'], ['Default Current_Timestamp'], []], [['Not Null'], ['Not Null', 'Unique'], ['Primary Key', 'Identity(001,1)'], ['Default Current_Timestamp'], []]]
...
Script_Table_CommentLine_List = ['Table-xxx-Start','Operation-Query-CURD','Create','Update-All','Table-xxx-End']
