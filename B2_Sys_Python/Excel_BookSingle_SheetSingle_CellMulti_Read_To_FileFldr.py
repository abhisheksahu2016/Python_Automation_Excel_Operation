...
#Excel_Path = ("C:/Users/ABHISHEK/Desktop/Final.xlsx")
Excel_Path = ("P:/Professional_Mission/1.Wipro/1.E-FullTime/1.Esubject/1.Trng/1.PBT-PJP/2.Action/2.Preparation/2.Study/3.PJP-Knlg_Kit/try/example.xlsx")
...
path = "P:/Professional_Mission/1.Wipro/1.E-FullTime/1.Esubject/1.Trng/1.PBT-PJP/2.Action/2.Preparation/2.Study/3.PJP-Knlg_Kit/try/"
temp_path=""
                    ...
                    if Chk_CellValueType is True :
                        ...
                        if Chk_Shortcut is True : 
                            if 'V-0.0.0.txt.lnk' in temp_str:
                                Src_Path = 'F:/1.Fuschia_1.0.8/3.Pro_Data/2.Fuschia_DTsn/2.Kernal_Space/3.Application_Memory/Shaktiman/3.Pro_Data/2.StMn_Datation/3.Information/2.Data/21.Brough/1.xxx_V-0.0.0.txt.lnk'
